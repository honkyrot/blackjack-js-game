...
function push_player_card(index, card) {
    if (player_hand[index] == undefined) {
        ...
        score_text.style = "margin: 0px; padding: 0px; font-size: 18px; text-align: center; color: white;"

        score_text.innerHTML = `<span id=\"player_hand_value_${index}\">0</span>`
...
function action_double() {
    if (player_score[current_player_index] < 21) {
        ...
        score_text.innerHTML = `<span id=\"player_hand_value_${current_player_index}\">${player_score[current_player_index]}</span>`
